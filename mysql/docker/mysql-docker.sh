...
echo_exec "cp docker-my.cnf /data/mysql/"
#echo_exec "docker run -p 3306:3306 --restart always --name mysql -v /data/mysql/logs:/logs -v /data/mysql/data:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=123456 -d mysql:5.7"
